...
import ttr.model.player.RoutePlayer;
import ttr.model.player.StupidPlayer;
import ttr.model.player.TrainPlayer;
import ttr.model.player.ek4ks;
...
public class TTRMain {
	...
	public static void main(String[] args) {
		...
		Player player1 = new RoutePlayer();
		Player player2 = new TrainPlayer("Hello");
